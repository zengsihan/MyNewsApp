...
//    getItemOffsets:通过outRect.set()为每个item设置偏移量。
     ...
     */
    public MyItem(Context context, int orientation, int drawableId) {
     ...
     */
    public MyItem(Context context, int orientation, Drawable drawable) {
        this(context, orientation);
        mDivider = drawable;
        mDividerHeight = mDivider.getIntrinsicHeight();
    }
     ...
     */
    public MyItem(Context context, int orientation, Drawable drawable, int
            drawableHeight) {
        this(context, orientation);
        mDivider = drawable;
     ...
     */
    public MyItem(Context context, int orientation, int dividerHeight, int
            dividerColor) {
        this(context, orientation);
